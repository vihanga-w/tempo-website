...
export const metadata: Metadata = {
  title: "Tempo.",
  description: "The social music platform",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" style={{
      ...
      <head>
        {/* Site Metadata */}
        <meta name="application-name" content="Tempo." />
        ...
        <link rel="shortcut icon" type="image/png" sizes="96x96" href="/icons/android/android-launchericon-96-96.png" />
        ...
        <link href="/inter.css" rel="stylesheet" as="style" />
        <link href="/libre-franklin.css" rel="stylesheet" as="style" />
      </head>
      <body style={{
        height: "100%",
        width: "100%",
